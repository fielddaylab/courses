...
url        = $fdl_logins[:fielddaylearn][:url]
username   = $fdl_logins[:fielddaylearn][:username]
password   = $fdl_logins[:fielddaylearn][:password]
remote_dir = $fdl_logins[:fielddaylearn][:remote_dir]
